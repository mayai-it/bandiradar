...
| **Puglia** | pr2127.regione.puglia.it (Liferay) | News-list fragment with 'Bando aperto' badges; detail pages rich. 2026-06: host drops big-cloud IPs — runners (Azure) AND the EU relay (Vercel/AWS) — while other EU datacenters get 200 | ✅ **Built** (`puglia`, v0.9.0) — LLM scraper; **CI monitor blocked despite the relay** (same class as Abruzzo). Works locally; data already in the corpus. |
